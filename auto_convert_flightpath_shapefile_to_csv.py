...
def extract_flight_line(line_number, start_gps_time, end_gps_time, shapefile_name):
    """
...
def process_flight_lines_from_csv(csv_filepath):
    ...
    for idx, row in df.iterrows():
        ...
        # Determine start and end times (north is always start, south is always end)
        start_time = north_time
        end_time = south_time
        
        # Extract the flight line
        success = extract_flight_line(line_number, start_time, end_time, shapefile)
